...
function App() {
  ...
  <h4>&lt; Between 1 and 20 &gt;</h4>
   ...
   <Input basedonevent={result} score={score} attempt={attempt} guss={guss}  changehandler={changehandler}/>
   <div className="rule">
    <h2>Rules</h2>
    <br />
    <ul>
      <li>You only have 5 chance to guss the number</li><br />
      <li>After 5 attempt game get started</li><br />
